...
const ResumeAnalyzer = () => {
  ...
  const analyzeResume = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${SERVICE_LOCAL_HOST}/api/ai/resume-analyser`,
        {
          pdfBase64: base64,
        },
      );
  ...
  const getPriorityColor = (priority: string) => {
    ...
    if (priority === "medium")
      return "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 border-yellow-200 dark:borderyellow-800";
              ...
              <>
                ...
                <div className="space-y-4 py-4">
                  <div
                    ...
                    className="border-2 border-dashed rounded-lg p-12 text-center cursorpointer
